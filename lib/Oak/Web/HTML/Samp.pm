...
Oak::Web::HTML::Samp - SAMP HTML Tag
...
L<Oak::Web::HTML::Samp|Oak::Web::HTML::Samp>


=head1 PROPERTIES

The Oak::Web::HTML::Samp object has the following properties:
