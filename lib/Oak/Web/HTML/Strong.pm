...
Oak::Web::HTML::Strong - STRONG HTML Tag
...
L<Oak::Web::HTML::Strong|Oak::Web::HTML::Strong>


=head1 PROPERTIES

The Oak::Web::HTML::Strong object has the following properties:
