...
Oak::Web::HTML::Caption - CAPTION HTML Tag
...
L<Oak::Web::HTML::Caption|Oak::Web::HTML::Caption>


=head1 PROPERTIES

The Oak::Web::HTML::Caption object has the following properties:
...
sub show {
	...
	print ">".$self->get('caption')."</CAPTION>\n";
}
