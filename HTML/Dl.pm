...
Oak::Web::HTML::Dl - DL HTML tag (Container)
...
L<Oak::Web::HTML::Dl|Oak::Web::HTML::Dl>


=head1 PROPERTIES

The Oak::Web::HTML::Dl object has the properties defined by W3C
