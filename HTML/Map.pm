...
Oak::Web::HTML::Map - Map HTML tag (Container)
...
L<Oak::Web::HTML::Map|Oak::Web::HTML::Map>


=head1 PROPERTIES

The Oak::Web::HTML::Map object has the properties defined by W3C
